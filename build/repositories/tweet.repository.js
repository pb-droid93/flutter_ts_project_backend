...
// get tweet 
const getTweetRepo = (tweedId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const tweet = yield tweet_model_1.default.findOne({ tweetId: tweedId });
        return tweet;
    }
    catch (error) {
        console.log(error);
...
//update a tweet
const updateTweetRepo = (tweedId, updateTweet) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield tweet_model_1.default.findOneAndUpdate({ tweetId: tweedId }, updateTweet, { new: true });
        if (result) {
            return true;
        }
        else {
